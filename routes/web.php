...
Route::get('entra/{UID}','HardwareController@decide');
...
Route::get('/editar-perfil/','UsuarioController@editPerfil');
Route::post('/admin-editperfil/{id}','UsuarioController@updatePerfil');
