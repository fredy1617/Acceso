            ...
            <div class="col-lg-6">
			    ...
			    <div class="form-group">
		        	<div class="form-group{{ $errors->has('Sexo') ? ' has-error' : '' }}">
						...
						{{Form::select('Sexo', ['' => 'Elije', 'HOMBRE' => 'HOMBRE', 'MUJER' => 'MUJER'], null, ['class'=>'form-control'])}}
							@if ($errors->has('Sexo'))
			                    <small class="text-danger">
			    ...
			    <div class="form-group">
		        	<div class="form-group{{ $errors->has('U_Admin') ? ' has-error' : '' }}">
						...
						{{Form::select('U_Admin', ['' => 'Elije', 'Fresnillo' => 'Fresnillo', 'Zacatecas' => 'Zacatecas', 'Mazapil' => 'Mazapil'], null, ['class'=>'form-control'])}}
            ...
            <div class="col-lg-6">
            	<div class="form-group"> 		        	
            		<div class="form-group{{ $errors->has('Fecha_Nacimiento') ? ' has-error' : '' }}"> 		        		
            			...
            			{{Form::text('Fecha_Nacimiento', $miembro->Fecha_Nacimiento, ['class'=>'form-control', 'placeholder'=>'Ej. 1998-10-21'])}} 
				...
				<div class="form-group col-lg-6">
		        	<div class="form-group{{ $errors->has('Estado_Civil') ? ' has-error' : '' }}">
						...
						{{Form::select('Estado_Civil', ['' => 'Elije', 'SOLTERO(A)' => 'SOLTERO(A)', 'CASADO(A)' => 'CASADO(A)', 'COMPROMETIDO(A)' => 'COMPROMETIDO(A)'], null, ['class'=>'form-control'])}}
